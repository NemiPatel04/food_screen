                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        ...
                        FadeAnimation(1.3, makeCategory(isActive: false, title: 'Burger')),
                        FadeAnimation(1.4, makeCategory(isActive: false, title: 'Kebab')),
                        FadeAnimation(1.5, makeCategory(isActive: false, title: 'Sandwich')),
                        FadeAnimation(1.6, makeCategory(isActive: false, title: 'Desert')),
                      ],
                    ),
                  ),
                  SizedBox(height: 10,),
            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.4, makeItem(image:'assets/images/The Creamiest Alfredo Pizza Recipe.png')),
                    FadeAnimation(1.5, makeItem(image:'assets/images/Free-Photo-_-Front-view-pizza-with-red-tomatoes-and-cheese-on-the-brown-wooden-round-desk-and-grey-f.png')),
                  ],
                ),
              ),
            ),
